...
function SortByNamexOlderThan(age) {
  ...
  // Sort awards in reverse chronological order. Reverse chronical order is nothing but descending order
  filteredPlayers.forEach(player => {
    player.awards.sort((a, b) => b.localeCompare(a));
  });
// either above or below both are correct for descending. We will use b-a for numbers i.e numberic values and localeCompare for strings i.e alphabets.
